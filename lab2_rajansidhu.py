...
#---------------------------------------------------------
num = 5
new_num = num * 10 - 5 # Add parenthesis to make new_num to be 35
...
#---------------------------------------------------------
increase = 0.2
increase_percentage = increase * 10
print(f"Exercise 6's increase percentage is: {increase_percentage}%")
#if the exerfcise 6 is out of 10 marks 0.2 would equal 2 percent, but if you are asking out of 100 make it "increase * 100"
