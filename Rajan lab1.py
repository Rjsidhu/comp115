...
#the error was the +, it had to be *
...
my_name = "Rajan" # Change to your name
my_github_account = "https://github.com/Rjsidhu" # Change to your GitHub account
my_hobby = "going to the gym and lifting weights" # Change to your hobby
