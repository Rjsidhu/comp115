...
Your answer is: they both have then same functionalities because they both return the index of the first occurrence of target in nums.
...
functionality? Why? (5 marks)
Your answer is: they have slightly diffrent functionalities
...
assert more_than_2(["apple", "banana", "apple", "apple", "pear", "orange", "banana", "banana", "watermelon"]) == ["apple", "banana"]
