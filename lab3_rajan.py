...
def draw_steps(num_steps):
    pen = turtle.Turtle()
    pen.speed(3)  # 1 sets the drawing speed as the slowest.
...
draw_steps(2)  # Call function draw_steps() with an argument 3 passing to num_steps
